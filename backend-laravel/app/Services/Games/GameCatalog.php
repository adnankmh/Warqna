...
class GameCatalog
{
    public static function all(): array
    {
        return [
            ...
            'banakil'=>['ar'=>'بناكل','en'=>'Banakil','min'=>2,'max'=>4,'partners'=>true,'engine'=>'banakil','targets'=>[222,150],'family'=>'meld','icon'=>'🎴','summary'=>'بناكل بمجموعتي ورق وجوكرات، نزول مجموعات وسلاسل والتخلص من اليد.'],
            ...
            'pinochle'=>['ar'=>'بناكل كلاسيك','en'=>'Classic Banakil','min'=>2,'max'=>4,'partners'=>true,'engine'=>'pinochle','targets'=>[222,150],'family'=>'meld','icon'=>'🂿','summary'=>'بناكل كلاسيك فردي أو شراكة، 18 ورقة و19 للبادئ، وتنزيل وتركيب ونقاط خاصة.'],
            ...
            'jackaroo'=>['ar'=>'جاكارو','en'=>'Jackaroo','min'=>4,'max'=>4,'partners'=>true,'engine'=>'jackaroo','targets'=>[],'family'=>'board','icon'=>'🟠','summary'=>'أربعة لاعبين بفريقين، إنزال وتحريك وتبديل وتقسيم سبعة وإدخال ثمانية أحجار إلى الأمان.'],
            'leekha'=>['ar'=>'ليخة','en'=>'Leekha','min'=>4,'max'=>4,'partners'=>true,'engine'=>'leekha','targets'=>[101],'family'=>'trick','icon'=>'♥️','summary'=>'تمرير ثلاث أوراق واتباع النوع وإجبار أوراق الليخة عند انعدام النوع؛ يفوز الفريق الأقل عقوبة.'],
        ];
    }
