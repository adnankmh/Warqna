...
const String warqnaAppVersion = String.fromEnvironment('WARQNA_APP_VERSION', defaultValue: '0.3.4');
const int warqnaAppBuild = int.fromEnvironment('WARQNA_APP_BUILD', defaultValue: 185);
