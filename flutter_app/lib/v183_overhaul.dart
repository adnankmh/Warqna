...
class AdaptiveTablePreviewV183 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      // Respect narrow grid cells instead of forcing a desktop-oriented
      // minimum width that can overflow 320–360 px phones.
      final width = availableWidth.clamp(1.0, gameplay ? 1500.0 : 920.0).toDouble();
