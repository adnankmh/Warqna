#!/usr/bin/env python3
"""Inherited V183 responsive web, store, boosters and engines contract."""
...
def main():
 ...
 if int(meta.get('build',0))<184: fail('release must inherit build 184 or newer')
 text('flutter_app/pubspec.yaml','assets/images/boosters/v183/')
 ...
 if "if (p.id.startsWith('table_reference_')) return false;" in main:
  fail('V185 approved reference tables must not be hidden from the customer UI')
