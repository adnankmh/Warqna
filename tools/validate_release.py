...
def check_v185_world_class_contract() -> None:
    result = subprocess.run(
        [sys.executable, str(ROOT / "tools/test_v185_world_class_contract.py")],
        cwd=ROOT,
        text=True,
        stdout=subprocess.PIPE,
        stderr=subprocess.STDOUT,
    ...
    if result.returncode != 0:
        fail("Warqna v185 world-class store contract failed: " + result.stdout.strip())
    for rel in [
        ".github/workflows/flutter-web-pages.yml",
        ".github/workflows/flutter-android.yml",
        ".github/workflows/flutter-ios.yml",
        ...
        require(rel, ["test_v185_world_class_contract.py"])
    print(result.stdout.strip())
