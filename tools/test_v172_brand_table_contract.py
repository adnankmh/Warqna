...
def main() -> None:
    ...
    if "if (p.id.startsWith('table_reference_')) return false;" in source:
        fail("V185 must expose the approved 40-table reference collection")
    if "part 'v185_world_class.dart';" not in source:
        fail("V185 world-class table marketplace is not connected to Flutter")
    ...
    print("[PASS] v172 assets remain compatible and V185 exposes the approved 40-table collection")
